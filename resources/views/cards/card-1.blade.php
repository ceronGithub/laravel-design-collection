...
<div class="navbar">
    ...
    <a href="./css/cards-css/card-one-css.css" Download>Download -> css file (click here)</a>
    <a href="./whole-project/project-one/project.html" Download>Download -> HTML file (click here)</a>
</div>    
    <div class="card-one" style="margin-top: 100px;">
